...
import CheckIcon from "../assets/正確.png"; // 假設這是你的正確圖標
import WrongIcon from "../assets/錯誤.png"; // 假設這是你的錯誤圖標
import ScoreDisplay from '../view/ScoreDisplay.tsx'; // 引入分數畫面元件

// 引入音效檔案
import CorrectSound from "../assets/正確音效.wav";   // <--- 答對音效
import WrongSound from "../assets/錯誤音效.wav";     // <--- 答錯音效
import GameOverSound from "../assets/查看分數音效2.wav"; // <--- 遊戲結束音效 (或分數頁面音效)
import ButtonClickSound from "../assets/遊戲開始介面音效.wav"; // <--- 引入按鈕點擊音效
